...
class _NamesWidgetState extends State<NamesWidget> {
  ...
  void sendNotification() {
    final nameData = _audioService.names.isNotEmpty ? _audioService.names[_audioService.currentIndex] : {};
  ...
  void previousName() async {
    ...
    int newIndex = (_audioService.currentIndex - 1) % _audioService.names.length;
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: () async {
                          await _audioService.seekToName(0); // Seek to the beginning
